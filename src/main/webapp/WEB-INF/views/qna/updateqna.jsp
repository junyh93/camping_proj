			...
			<table class="table_form">
				<tbody>
					...
					<tr>
						...
						<td class="w80"><input type="text" id="qnaTitle" name="qnaTitle" class="txt" value="${qna.qnaTitle }"></td>
					</tr>
					<tr>
						<td scope="col" class="gray w20"><label>문의하실 내용을 작성하세요.</label></td>
						<td class="w80"><textarea type="text" id="qnaContent" name="qnaContent" class="txt" >${qna.qnaContent }</textarea></td>
					</tr>
