...
<dt class="sbj">
	...
	공지사항			
	<a href="<c:url value='notice.do'/>" class="fr more" title="공지사항 더 보기">
	...
	<c:choose>
		...
		<c:when test="${!empty notice }">
			<c:forEach var="notice" items="${notice }" begin="0" end="6" step="1"> 
				<dd>
					<i class="fa fa-angle-right" aria-hidden="true"></i> &nbsp;
					<a href="<c:url value='getnotice.do?noticeNo=${notice.noticeNo}'/>">${notice.noticeTitle }</a>
				</dd> 
			</c:forEach>
		</c:when>												
	</c:choose>	 
