...
<form name="inputForm" id="inputForm" method="post" onsubmit="return _onSubmit();" action="insertNotice.do">

	<section class="find_pwd">
		<h3 class="basic_title">공지사항 작성</h3>
		<!--1:1문의 시작-->
			...
			<table class="table_form">
				<tbody>
					<tr>
						...
						<td class="w80"><input type="text" id="noticeTitle" name="noticeTitle" class="txt"></td>
					</tr>
					<tr>
						<td scope="col" class="gray w20"><label>문의하실 내용을 작성하세요.</label></td>
						<td class="w80"><textarea type="text" id="noticeContent" name="noticeContent" class="txt"></textarea></td>
					</tr>
				</tbody>
			</table>
		</div>
