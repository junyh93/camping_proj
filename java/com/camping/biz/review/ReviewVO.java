...
public class ReviewVO {
	...
	public String toString() {
		return "ReviewVO [rvNo=" + rvNo + ", rvDate=" + rvDate + ", rvTitle=" + rvTitle + ", rvContent=" + rvContent
				+ ", rvImg=" + rvImg + ", rvFolder=" + rvFolder + ", rvFolder1=" + rvFolder1 + ", rvFolder2="
				+ rvFolder2 + ", rvFolder3=" + rvFolder3 + ", rvFolder4=" + rvFolder4 + ", rvStar=" + rvStar
				+ ", rvHit=" + rvHit + ", contentId=" + contentId + ", addr=" + addr + ", facltNm=" + facltNm
				+ ", lineIntro=" + lineIntro + ", tel=" + tel + ", homePage=" + homePage + ", imgUrl=" + imgUrl
				+ ", mapX=" + mapX + ", mapY=" + mapY + ", memNo=" + memNo + ", memId=" + memId + "]";
	}
